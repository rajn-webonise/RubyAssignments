...
It simply tokenizes the given input string into keywords/identifiers.
...
The function also returns the line and colum number.
...
Finally here, the bytecode is generated. The AST is converted into YARV instruction set. This instruction set is then interpreted in C code.
